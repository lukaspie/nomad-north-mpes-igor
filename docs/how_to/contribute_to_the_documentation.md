...
3. **Register it in the nav** in [`mkdocs.yml`](https://github.com/FAIRmat-NFDI/nomad-north-mpes-igor/blob/main/mkdocs.yml){:target="_blank" rel="noopener"} -- a page not listed there won't appear in the site, even if it builds.
